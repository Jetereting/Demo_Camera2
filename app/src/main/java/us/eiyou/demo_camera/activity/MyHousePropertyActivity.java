...
import us.eiyou.demo_camera.adpter.LookShareAdapter;
...
//我的房产库
public class MyHousePropertyActivity extends Activity implements LookShareAdapter.Callback {

    Button btn_title_back;
    TextView tev_title_content;
    ListView listView;
    LookShareAdapter mAdapter;
    List<WaitUploadModel> list = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("MyHousePropertyActivity", "onCreate");
        ...
        Log.d("MyHousePropertyActivity", type);
        switch (type) {
            case "trip_share":
            case "trip_upload":
                mAdapter = new LookShareAdapter(this, list, 1, this);
                listView.setAdapter(mAdapter);
                tev_title_content.setText("旅游分享");
                break;
            case ("house_share"):
            case ("house_upload"):
                mAdapter = new LookShareAdapter(this, list, 2, this);
                listView.setAdapter(mAdapter);
        ...
        progressDialog = new ProgressDialog(MyHousePropertyActivity.this);
    ...
    public void click(final View v) {
        switch (v.getId()) {
            ...
            case R.id.button1:
                ...
                intent1.putExtra("name", name.split(";")[(Integer) v.getTag()] + "");
                intent1.putExtra("para", paraList[(Integer) v.getTag()]);
                Log.d("MyHousePropertyActivity", v.getTag().toString());
                intent1.putExtra("imgUrl", path.split(";")[(Integer) v.getTag()].split(",")[0]);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Log.d("MyHousePropertyActivity", " result.toString()" + result.toString());
                        } catch (Exception e) {
                            Log.d("MyHousePropertyActivity", "e:" + e.toString());
                            e.printStackTrace();
                        }
    ...
    private Handler handlerDelete = new Handler() {
        ...
        public void handleMessage(Message msg) {
            try {
                ...
                e.printStackTrace();
                Log.d("MyHousePropertyActivity", e.toString());
            }
        }
    };
